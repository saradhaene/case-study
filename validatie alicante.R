...
STATION_NAME <- Sys.getenv("STATION_NAME", "Alicante")
STATION_FILE <- Sys.getenv("STATION_FILE", "alicante.xlsx")
NAO_FILE     <- Sys.getenv("NAO_FILE", "NAO_cleaned.xlsx")   # must contain DATE + nao column
...
# Output directory
OUT_DIR <- file.path(DATA_DIR, "outputs_all_stations", STATION_NAME)
...
RUN_3FOLD_CV <- as.logical(Sys.getenv("RUN_3FOLD_CV", "FALSE"))
